...
* How much time do students save using AI tools?
...
🔹 Page 1: Overview (Performance & Adoption)

* KPI Cards: Total Students, GPA Before & After AI, GPA Improvement, Time Saved
* GPA Comparison (Before vs After by Major)
* AI Tool Distribution (Donut Chart)
* Ethics Concern Breakdown (Pie Chart)

Provides a high-level summary of AI impact

🔹 Page 2: Detailed Analysis (Behavior & Productivity)

* AI Usage Case Distribution (Horizontal Bar Chart)
* GPA vs AI Usage Frequency (Scatter Plot)
* Average GPA Analysis by Usage Case and AI Tool (Stacked Column Chart)
* Additional behavioral and performance insights
...
* AI tools significantly reduce time spent on academic tasks
* Students primarily use AI for code debugging, essay drafting, and exam preparation
* Different AI tools show similar effectiveness in improving performance
...
* Combination of performance, productivity, and behavioral analysis
* Use of multiple visualization types (bar, column, pie, donut, scatter, stacked)
...
3. Explore both dashboard pages
